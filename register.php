            ...
            <div class="card rounded">
              ...
              <div class="tab-content">
                <div class="tab-pane container active" id="hospitals">
                  <form action="admin/hospitalReg.php" method="post" enctype="multipart/form-data">
                    <input type="text" name="hname" placeholder="Hospital Name" class="form-control mb-3 mt-3" required>
                ...
                <div class="tab-pane container fade" id="receivers">
                  <form action="admin/receiverReg.php" method="post" enctype="multipart/form-data">
                    <input type="text" name="rname" placeholder="User Name" class="form-control mb-3 mt-3" required>
