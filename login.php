          ...
          <div class="card rounded">
            ...
            <div class="tab-content">
              <div class="tab-pane container active" id="hospitals">
                <form action="admin/hospitalLogin.php" class="login-form" method="post">
                  <label class="text-muted font-weight-bold" class="text-muted font-weight-bold mt-3">Hospital Email</label>
              ...
              <div class="tab-pane container fade" id="receivers">
                <form action="admin/receiverLogin.php" class="login-form" method="post">
                  <label class="text-muted font-weight-bold" class="text-muted font-weight-bold mt-3">User Email</label>
